...
func main() {
	...
	// ch, _ := conn.Channel()
	// q, _ := ch.QueueDeclare("users", false, false, false, false, nil)
	// ch.Publish("", q.Name, false, false, amqp.Publishing{ContentType: "text/plain", Body: []byte("Hello, Suka!")})
